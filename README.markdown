This was a group project in Computer Organization. Most of the code for spimcore.h and spimcore.c was already written, we just filled in the functions in project.c.
